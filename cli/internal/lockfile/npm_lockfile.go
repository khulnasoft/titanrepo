...
func (l *NpmLockfile) Subgraph(workspacePackages []titanpath.AnchoredSystemPath, packages []string) (Lockfile, error) {
...
func (l *NpmLockfile) Patches() []titanpath.AnchoredUnixPath {
	return nil
}
