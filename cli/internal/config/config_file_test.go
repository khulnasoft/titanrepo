...
func TestReadRepoConfigSetTeamAndAPIFlag(t *testing.T) {
	testConfigFile := fs.AbsoluteSystemPathFromUpstream(t.TempDir()).UntypedJoin("titanrepo", "config.json")
	flags := pflag.NewFlagSet("test-flags", pflag.ContinueOnError)
	AddRepoConfigFlags(flags)
...
func TestWriteRepoConfig(t *testing.T) {
	...
	testConfigFile := repoRoot.UntypedJoin(".titan", "config.json")
	flags := pflag.NewFlagSet("test-flags", pflag.ContinueOnError)
	AddRepoConfigFlags(flags)
...
func TestWriteUserConfig(t *testing.T) {
	configPath := fs.AbsoluteSystemPathFromUpstream(t.TempDir()).UntypedJoin("titanrepo", "config.json")
	flags := pflag.NewFlagSet("test-flags", pflag.ContinueOnError)
