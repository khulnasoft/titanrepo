...
import (
	...
	"github.com/khulnasoft/titanrepo/cli/internal/cmd/auth"
	"github.com/khulnasoft/titanrepo/cli/internal/cmd/info"
	"github.com/khulnasoft/titanrepo/cli/internal/cmdutil"
	"github.com/khulnasoft/titanrepo/cli/internal/daemon"
	"github.com/khulnasoft/titanrepo/cli/internal/login"
	"github.com/khulnasoft/titanrepo/cli/internal/process"
	"github.com/khulnasoft/titanrepo/cli/internal/prune"
	"github.com/khulnasoft/titanrepo/cli/internal/run"
...
func (eo *execOpts) addFlags(flags *pflag.FlagSet) {
	...
	// know the repo root, depending on how titan was invoked.
...
// RunWithArgs runs titan with the specified arguments. The arguments should not
// include the binary being invoked (e.g. "titan").
func RunWithArgs(args []string, titanVersion string) int {
	util.InitPrintf()
	// TODO: replace this with a context
	signalWatcher := signals.NewWatcher()
	helper := cmdutil.NewHelper(titanVersion)
