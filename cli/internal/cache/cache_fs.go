...
func (f *fsCache) Fetch(anchor titanpath.AbsoluteSystemPath, hash string, _unusedOutputGlobs []string) (bool, []titanpath.AnchoredSystemPath, int, error) {
...
func (f *fsCache) Clean(anchor titanpath.AbsoluteSystemPath) {
