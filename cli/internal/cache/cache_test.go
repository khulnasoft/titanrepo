...
func (tc *testCache) Fetch(anchor titanpath.AbsoluteSystemPath, hash string, files []string) (bool, []titanpath.AnchoredSystemPath, int, error) {
...
func (tc *testCache) Put(anchor titanpath.AbsoluteSystemPath, hash string, duration int, files []titanpath.AnchoredSystemPath) error {
	if tc.disabledErr != nil {
...
func (tc *testCache) Clean(anchor titanpath.AbsoluteSystemPath) {}
