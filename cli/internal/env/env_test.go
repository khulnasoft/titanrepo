...
func TestGetHashableEnvPairs(t *testing.T) {
	...
	tests := []struct {
		...
		{
			env:  []string{"NEXT_PUBLIC_KHULNASOFT_ENV=true", "MANUAL=true", "MANUAL_KHULNASOFT_ENV=true", "TITAN_CI_VENDOR_ENV_KEY=NEXT_PUBLIC_KHULNASOFT_"},
			name: "$TITAN_CI_VENDOR_ENV_KEY excludes automatically added env vars",
			args: args{
				envKeys:     []string{"MANUAL"},
				envPrefixes: []string{"NEXT_PUBLIC_"},
			},
		...
		{
			env:  []string{"TITAN_ENV=true", "MANUAL=true", "TITANREPO=true", "TITAN_CI_VENDOR_ENV_KEY=TITAN_"},
			name: "$TITAN_CI_VENDOR_ENV_KEY excludes automatically added env vars",
			args: args{
				envKeys:     []string{},
				envPrefixes: []string{"TITAN"},
			},
			want: []string{"TITANREPO=true"},
		},
		{
			env:  []string{"NEXT_PUBLIC_MY_KHULNASOFT_URL=me.khulnasoft.com", "TITANREPO=true", "TITAN_CI_VENDOR_ENV_KEY=NEXT_PUBLIC_KHULNASOFT_"},
			name: "$TITAN_CI_VENDOR_ENV_KEY excludes automatically added env vars",
			args: args{
				envKeys:     []string{"TITANREPO"},
				envPrefixes: []string{"NEXT_PUBLIC"},
			},
			want: []string{"NEXT_PUBLIC_MY_KHULNASOFT_URL=me.khulnasoft.com", "TITANREPO=true"},
		},
		{
			env:  []string{"TITAN_CI_VENDOR_ENV_KEY_VAL=true", "TITAN_CI_VENDOR_ENV_KEY=TITAN_CI_VENDOR_ENV_KEY"},
			name: "$TITAN_CI_VENDOR_ENV_KEY should not exclude itself",
			args: args{
				envKeys:     []string{},
				envPrefixes: []string{"TITAN_"},
			},
			want: []string{},
		},
		{
			env:  []string{"NEXT_PUBLIC_KHULNASOFT_ENV=true", "MANUAL=true", "TITAN_CI_VENDOR_ENV_KEY=_KHULNASOFT_"},
			name: "blocked env var is allowed if manually specified",
			args: args{
				envKeys:     []string{"NEXT_PUBLIC_KHULNASOFT_ENV", "MANUAL"},
				envPrefixes: []string{"NEXT_PUBLIC_"},
			},
			want: []string{"MANUAL=true", "NEXT_PUBLIC_KHULNASOFT_ENV=true"},
		},
	}
