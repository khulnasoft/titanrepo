...
///
/// https://github.com/khulnasoft/titanrepo/blob/main/packages/titan-telemetry/src/config.ts
use std::env;
...
use titanrepo_ui::{color, ColorConfig, BOLD, GREY, UNDERLINE};
use uuid::Uuid;
            ...
            eprintln!(
                ...
                color!(
                    ...
                    color!(
                        ...
                        GREY,
                        "{}",
                        "https://titan.build/repo/docs/telemetry"
                    )
                ),
            );
...
fn default_config_path() -> Result<AbsoluteSystemPathBuf, ConfigError> {
    ...
    Ok(config_dir.join_components(&["titanrepo", "telemetry.json"]))
}
