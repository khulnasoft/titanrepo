...
mod test {
    ...
    #[test_case("\ra whole message \n", "titan > \rtitan > a whole message \n" ; "basic prefix cr")]
    #[test_case("no return", "titan > no return" ; "no return")]
    #[test_case("foo\rbar\rbaz", "titan > foo\rtitan > bar\rtitan > baz" ; "multiple crs")]
    #[test_case("foo\r", "titan > foo\r" ; "trailing cr")]
    ...
    fn test_prefixed_writer_split_lines() {
        ...
        assert_eq!(
            ...
            "titan > not a line yet, now\ntitan > but \rtitan > another one starts done\ntitan > \
             \n"
        );
    }
}
