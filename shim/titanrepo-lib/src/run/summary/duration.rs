...
#[derive(Debug)]
pub struct TitanDuration(Duration);
...
impl From<Duration> for TitanDuration {
    fn from(duration: Duration) -> Self {
        Self(duration)
    }
}

impl fmt::Display for TitanDuration {
...
mod test {
    ...
    #[test_case(TitanDuration::from(Duration::milliseconds(120)), "120ms")]
    #[test_case(TitanDuration::from(Duration::milliseconds(1500)), "1.5s")]
    #[test_case(TitanDuration::from(Duration::milliseconds(1234)), "1.234s")]
    #[test_case(TitanDuration::from(Duration::seconds(90)), "1m30s")]
    fn duration_formatting(duration: TitanDuration, expected: &str) {
