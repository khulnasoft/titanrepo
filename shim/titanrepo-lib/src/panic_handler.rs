...
const OPEN_ISSUE_MESSAGE: &str =
    "Please open an issue at https://github.com/khulnasoft/titanrepo/issues/new/choose";
...
pub fn panic_handler(panic_info: &std::panic::PanicHookInfo) {
    ...
    // to retrieve.
    let should_persist = !titanrepo_ci::is_ci() && titanrepo_ci::Vendor::infer().is_none();
