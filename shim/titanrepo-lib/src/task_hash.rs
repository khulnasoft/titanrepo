...
use titanrepo_env::{BySource, DetailedMap, EnvironmentVariableMap};
use titanrepo_repository::package_graph::{PackageInfo, PackageName};
                            ...
                            match result {
                                Ok(hashes_resp) => Some(
                                    hashes_resp
                                        ...
                                        .map(|(path, hash)| {
                                            (
                                                titanpath::RelativeUnixPathBuf::new(path)
