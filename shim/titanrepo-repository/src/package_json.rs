...
use titanrepo_errors::{ParseDiagnostic, Spanned, WithMetadata};
...
mod test {
    ...
    #[test_case(json!({"dependencies": { "titan": "latest" }, "foo": "bar"}) ; "dependencies")]
    #[test_case(json!({"devDependencies": { "titan": "latest" }, "foo": "bar"}) ; "dev dependencies")]
    #[test_case(json!({"optionalDependencies": { "titan": "latest" }, "foo": "bar"}) ; "optional dependencies")]
    #[test_case(json!({"peerDependencies": { "titan": "latest" }, "foo": "bar"}) ; "peer dependencies")]
    #[test_case(json!({"scripts": { "build": "titan build" }, "foo": "bar"}) ; "scripts")]
    #[test_case(json!({"resolutions": { "titan": "latest" }, "foo": "bar"}) ; "resolutions")]
