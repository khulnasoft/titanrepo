...
/// The WorkspacePackage follows the Khulnasoft glossary of terms where "Workspace"
...
impl PackageGraph {
    ...
    pub fn dependencies<'a>(&'a self, node: &PackageNode) -> HashSet<&'a PackageNode> {
        let mut dependencies = titanrepo_graph_utils::transitive_closure(
            &self.graph,
    ...
    pub fn changed_packages_from_lockfile(
        ...
        let closures = titanrepo_lockfiles::all_transitive_closures(previous, external_deps, true)?;
