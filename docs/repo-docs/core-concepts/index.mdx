---
title: Core concepts
description: Learn about the core concepts behind Titanrepo.
---

import { Card, Cards } from '#/components/card';

Learn more about the core concepts of Titanrepo:
...
<Card
  ...
  description="How Titanrepo relates your tasks to each other"
/>
