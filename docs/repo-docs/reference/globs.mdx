...
description: Learn about the file glob specification used by `titan`.
---

File globs are used throughout Titanrepo for configuring which files to include or exclude in various contexts, allowing you to specifically define the files you want `titan` to use.
