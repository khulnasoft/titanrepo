---
title: CircleCI
description: Learn how to use CircleCI with Titanrepo.
---
...
<Callout type="warn" title="TTY on CircleCI">
  ...
  that crash Titanrepo's terminal UI. To workaround this, set the
  `TITAN_UI=false` environment variable in your CircleCI configuration.
</Callout>
...
1. Create a Scoped Access Token to your account in the [Vercel Dashboard](https://khulnasoft.com/account/tokens)
...
3. Make a second secret called `TITAN_TEAM` and enter the value of your team's Vercel URL _without_ the `khulnasoft.com/`. Your Team URL can be found inside your team's general project settings from the dashboard.

   If you're using a Hobby Plan, you can use your username. Your username can be found in your [Vercel Personal Account Settings](https://khulnasoft.com/account)
