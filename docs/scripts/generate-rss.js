...
async function generate() {
  const feed = new RSS({
    title: "Titanrepo Blog",
    description: "Titanrepo news, updates, and announcements.",
    site_url: "https://titan.khulnasoft.com",
    feed_url: "https://titan.khulnasoft.com/feed.xml",
    image_url: "https://titan.khulnasoft.com/og-image.png",
  });
  ...
  for (const frontmatter of sortedData) {
    ...
    feed.item({
      ...
      url: "https://titan.khulnasoft.com/blog/" + frontmatter.slug, // intentionally including slash here
      date: frontmatter.data.date,
      description: frontmatter.data.description,
      enclosure: {
        url: "https://titan.khulnasoft.com" + frontmatter.data.ogImage, // intentionally omitting slash here
        type: "image/png",
        size: stat.size,
      },
    });
