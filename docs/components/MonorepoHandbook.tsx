  ...
  return (
    <Wrapper>
      <DetailedFeatureLink
        feature={{
          Icon: PencilAltIcon,
          description: `Learn how to set up your dev scripts using Titanrepo.`,
      ...
      <DetailedFeatureLink
        feature={{
          Icon: CodeIcon,
          description:
            "Get framework-specific guides for building your apps with Titanrepo.",
      ...
      <DetailedFeatureLink
        feature={{
          Icon: DockerIcon,
          description:
            "Make use of Titanrepo's prune command to keep your Docker deploys fast.",
