...
import KhulnasoftLogo from "./logos/Khulnasoft";
...
const navigation = {
  general: [
    ...
    {
      name: "Releases",
      href: "https://github.com/khulnasoft/titanrepo/releases",
    },
    { name: "FAQ", href: "/docs/faq" },
    {
      name: "Enterprise",
      href: "https://khulnasoft.com/contact/titanrepo?utm_source=titan.khulnasoft.com&utm_medium=referral&utm_campaign=footer-enterpriseLink",
    },
  ],
  support: [
    {
      name: "GitHub",
      href: "https://github.com/khulnasoft/titanrepo",
    },
    {
      name: "Discord",
      href: "https://titan.khulnasoft.com/discord",
    },
  ],
  company: [
    {
      name: "Open Source Software",
      href: "https://khulnasoft.com/oss?utm_source=titan.khulnasoft.com&utm_medium=referral&utm_campaign=footer-ossLink",
    },
    { name: "GitHub", href: "https://github.com/khulnasoft" },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 xl:!mt-0">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-500">
              Join the Titanrepo newsletter and stay updated on new releases and
        ...
        <div className="pt-8 mt-8 md:flex md:items-center md:justify-between">
          <div>
            <a
              ...
              href="https://khulnasoft.com?utm_source=titan.khulnasoft.com&utm_medium=referral&utm_campaign=footer-logoLink"
            >
              <KhulnasoftLogo />
            </a>
