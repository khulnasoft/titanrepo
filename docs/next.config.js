...
const nextConfig = withNextra({
      ...
      beforeFiles: [
        {
          source: "/sitemap.xml",
          destination:
            "https://crawled-sitemap.khulnasoft.sh/titan-sitemap.xml",
        },
      ],
    };
  },
  async redirects() {
    return [
      ...
      {
        source: "/docs/core-concepts/why-titanrepo",
      ...
      },
      {
        ...
        permanent: true,
        destination: "https://github.com/khulnasoft/titanrepo/releases",
      },
      {
