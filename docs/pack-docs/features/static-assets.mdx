---
title: Static Assets
description: Learn more about static assets in Titanpack.
---

Part of bundling for the web is handling all the asset types the web supports - images, JSON, and much more. Titanpack offers familiar tools for these so you can immediately get productive.

## Import static assets

Importing static assets works out of the box with Titanpack:
...
This is supported out of the box with Titanpack, as is performing a named import on that JSON:
