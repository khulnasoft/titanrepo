---
title: Dev Server
description: Learn more about the Titanpack Dev Server.
---

Titanpack is optimized to give you an extremely fast development server. We considered these features indispensable.
...
Titanpack supports Hot Module Replacement out of the box. Because of our [incremental architecture](/pack/docs/core-concepts), we are hyper-optimized for delivering fast updates.
...
Titanpack supports Fast Refresh out of the box for React. Support for other frameworks will be [added over time](/pack/docs/features/frameworks).
