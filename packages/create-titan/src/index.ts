...
async function run() {
  ...
  console.log(chalk.bold(titanGradient(`\n>>> TITANREPO\n`)));
  await new Promise((resolve) => setTimeout(resolve, 500));
  console.log(
    ">>> Welcome to Titanrepo! Let's get you set up with a new codebase."
  );
  console.log();
  ...
  console.log();
  console.log(`>>> Created a new titanrepo with the following:`);
  console.log();
  ...
  console.log();
  console.log(`Titanrepo will cache locally by default. For an additional`);
  console.log(`speed boost, enable Remote Caching with Khulnasoft by`);
  console.log(`entering the following command:`);
  console.log();
  console.log(chalk.cyan(`  ${packageManager.executable} titan login`));
  console.log();
    ...
    if (res?.latest) {
      ...
      console.log(
        "You can update by running: " +
          chalk.cyan(
            isYarn ? "yarn global add create-titan" : "npm i -g create-titan"
          )
      );
      console.log();
    }
